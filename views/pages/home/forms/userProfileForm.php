<fieldset>
    ...
    <input type="number" id="age" name="user[age]" min="1" max="120" placeholder="Ej: 28" value="<?php echo escapeHTML($userProfile->age); ?>">

    <!-- Weight -->
    <label for="weight" class="icon-label icon-label--weight">Peso (kg)</label>
    <input type="number" id="weight" name="user[weight]" step="0.01" min="20" max="500" placeholder="Ej: 80" value="<?php echo escapeHTML($userProfile->weight); ?>">

    <!-- Height -->
    <label for="height" class="icon-label icon-label--height"> Altura (cm)</label>
    <input type="number" id="height" name="user[height]" step="0.01" placeholder="Ej: 175" value="<?php echo escapeHTML($userProfile->height); ?>">

    <!-- Gender -->
    <label for="gender" class="icon-label icon-label--gender">Genero</label>
    <select id="gender" name="user[gender_id]" class="select">
    ...
    <select id="activity_level" name="user[activity_level_id]" class="select">
    ...
    <select id="goal" name="user[goal_id]" class="select">
